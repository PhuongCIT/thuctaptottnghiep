...
const Appointment = () => {
  ...
  const { staffs, backendUrl } = useContext(AppContext);
  ...
  const fetchServiceInfo = async () => {
    try {
      setIsLoading(true);
      setError(null);
      const res = await axios.get(`${backendUrl}/services/${serId}`);
      const serviceInfo = res.data.data?.service || res.data.data;
    ...
    serviceInfo && (
      <div className="">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div>
            <img
              className="bg-primary w-full h-96 sm:max-w-96  rounded-lg"
              src={cattoc}
          ...
          <div className="flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
            ...
            <p className="text-gray-500 font-medium mt-4">
              Giá : <span className="text-gray-600 ">{serviceInfo.price}</span>
            </p>
            <p className="text-gray-500 font-medium mt-4">
              Thời gian làm {serviceInfo.duration} phút
            </p>
            <div>
        ...
        <div className="sm:ml-7 sm:pl-4 mt-4 font-medium text-gray-700">
          <p className="text-3xl">Đặt lịch</p>
